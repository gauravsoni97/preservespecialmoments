                    ...
                    {cart.map((item) => (
                      <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-pink-600 font-semibold">₹{item.price * 83}</p>
                        </div>
                        <div className="flex items-center space-x-2">
                          <button
              ...
              {cart.length > 0 && (
                <div className="border-t border-gray-200 p-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-2xl font-bold text-pink-600">₹{getTotalPrice() * 83}</span>
                  </div>
                  <button
                    onClick={() => {
                      setIsCartOpen(false);
            ...
            <div className="relative bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 mb-6">
                <div className="text-center mb-4">
                  <div className="text-3xl font-bold text-pink-600">₹{getTotalPrice() * 83}</div>
                  <div className="text-sm text-gray-600">Total Amount</div>
                </div>

                <div className="bg-white p-4 rounded-xl shadow-inner mb-4">
                  <QRCodeSVG 
                    value={`upi://pay?pa=merchant@example.com&pn=PreserveSpecialMoments&am=${getTotalPrice() * 83}&cu=INR`}
                    size={192}
                    level="H"
                    includeMargin={true}
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-xl">
                  ...
                  <span className="text-sm text-gray-700">Complete payment of ₹{getTotalPrice() * 83}</span>
                </div>
              ...
              <div className="flex space-x-3">
                ...
                <a
                  href={`https://wa.me/1234567890?text=Payment%20of%20₹${getTotalPrice() * 83}%20completed%20for%20order`}
                  target="_blank"
